...
globalkeys = my_table.join(
    ...
    awful.key({ modkey }, "c", function () awful.util.spawn( "clementine" ) end,
        {description = "clementine", group = "super"}),
    ...
    --awful.key({ modkey }, "e", function () awful.util.spawn( "element-desktop" ) end,
        --{description = "element", group = "super"}),
    awful.key({ modkey }, "r", function () awful.util.spawn( "runelite" ) end,
        {description = "runescape", group = "super"}),
    awful.key({ modkey }, "d", function () awful.util.spawn( "discord" ) end,
        {description = "discord", group = "super"}),
    awful.key({ modkey }, "m", function () awful.util.spawn( "okular" ) end,
        {description = "okular", group = "super"}),
    ...
    awful.key({ modkey }, "b",  function () awful.util.spawn( "torbrowser-launcher" ) end,
        {description = "torbrowser-launcher", group = "super"}),
    awful.key({ modkey }, "a",  function () awful.util.spawn( "anki" ) end,
        {description = "anki", group = "super"}),
    awful.key({ modkey }, "v",  function () awful.util.spawn( "firefox" ) end,
        {description = "firefox", group = "super"}),
    awful.key({ modkey }, "j",  function () awful.util.spawn( "joplin-desktop" ) end,
        {description = "joplin", group = "super"}),
